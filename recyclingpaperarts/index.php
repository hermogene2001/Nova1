...
// Process login form submission (handle POST request) - EXCLUDE admin role
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Exclude admin role from main login page
...
<head>
    ...
    <title>Recycling Paper Arts - Magazine Login</title>
        ...
        <div class="login-wrapper">
            ...
            <div class="login-section">
                <div class="login-header">
                    ...
                    <p class="login-subtitle">Access your magazine dashboard</p>
                </div>
