...
<head>
    ...
    <title>Recycling Paper Arts - Subscribe to Magazine</title>
        ...
        <div class="login-wrapper">
            ...
            <div class="brand-section">
                <div class="brand-content">
                    ...
                    <p class="brand-tagline">Creative Paper Artistry Excellence</p>
                    
                    <ul class="features-list">
                        <li>
                            <i class="fas fa-chart-line"></i>
                            <span>Daily Profit Cycles</span>
                        </li>
                        <li>
                            <i class="fas fa-shield-alt"></i>
            ...
            <div class="login-section">
                <div class="login-header">
                    <h2 class="login-title">Subscribe Now</h2>
                    <p class="login-subtitle">Create your magazine account</p>
                </div>

                <?php if (!empty($referralCode)): ?>
                <div class="alert alert-info">
                    <i class="fas fa-gift"></i>
                    <span>You've been invited to join Recycling Paper Arts! Your invitation code is pre-filled below.</span>
                </div>
                <?php endif; ?>
                ...
                <form action="../actions/register.php" method="POST" id="registerForm">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" class="form-control" name="first_name" id="first_name" placeholder="Enter your first name" title="Please enter your real name" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" class="form-control" id="phone" name="phone_number" placeholder="Enter your phone number" title="Phone number should start with 07 and be 10 digits long" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" class="form-control" id="invitationCode" name="invitation_code" placeholder="Enter invitation code" required value="<?php echo htmlspecialchars($referralCode); ?>" <?php echo !empty($referralCode) ? 'readonly' : ''; ?>>
                            <i class="fas fa-ticket-alt input-icon"></i>
                        </div>
                    </div>

                    <button type="submit" class="btn-login">
                        <i class="fas fa-sign-in-alt"></i> Subscribe to Magazine
                    </button>
                </form>
                ...
                <div class="info-cards">
                    <div class="info-card">
                        ...
                        <p>Discover Creative Paper Artistry</p>
                    </div>
                    <div class="info-card">
                        <i class="fas fa-headset"></i>
                        <h4>24/7 Support</h4>
                        <p>Expert Guidance Anytime</p>
                    </div>
                </div>
            </div>
        </div>
